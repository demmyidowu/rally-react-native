 ...
 */
export const reverseGeocode = onCall(async (request): Promise<ReverseGeocodeResponse> => {
 ...
 */
export const calculateETA = onCall(async (request): Promise<CalculateETAResponse> => {
    // Verify user is authenticated
    if (!request.auth) {
